...
namespace AngularJSDataService
{
    public class ApplicationDataService : EntityFrameworkDataService, IApplicationDataService
    {
        public void InitializeApplication()
        {
            ...
            dbConnection.ApplicationMenuItems.Add(menuItem);
            //"#Library/BooksView" - to which module to switch
            // "Main"              - Visible when
            menuItem = CreateMenuItem("Books", "#Library/BooksView", "Main", true, 8);
            dbConnection.ApplicationMenuItems.Add(menuItem);

            menuItem = CreateMenuItem("Create Book", "#Library/CreateBook", "Library", true, 1);
            dbConnection.ApplicationMenuItems.Add(menuItem);

            menuItem = CreateMenuItem("Book Details", "#Library/BookDetails", "Library", true, 2);
            dbConnection.ApplicationMenuItems.Add(menuItem);
        ...
        /// <returns></returns>
        public ApplicationMenu CreateMenuItem(string description, string route, string module, Boolean requiresAuthenication, int menuOrder)
        {
